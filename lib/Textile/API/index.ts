...
class API {
  ...
  addThread = async (key: string, name: string, type: ThreadType, sharing: ThreadSharing, members: string[], schema: string, media: boolean, cameraRoll: boolean): Promise<ThreadInfo> => {
